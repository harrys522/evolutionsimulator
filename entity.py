...
class Entity:
    ...
    def __init__(self, sex=MALE, health=100, stamina=100, damage, damage_type, diet=0.5, locomotion: Locomotion, task: State, location: Coordinate, body_temp=33, nocturnal=False, size, resistance: Resistance):
        self.sex = sex
        self.health = health
